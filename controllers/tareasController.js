...
import { getTareaService, getTareasService, createTareaService, updateTareaService } from "../services/tareasServices.js";
...
export const createTareaController =  async (req, res, next) => {
    try {
        ...
        const tarea = await createTareaService( nombre, descripcion, estado );
